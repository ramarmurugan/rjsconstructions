    ...
    <div className='construction'>
      <div className='container'>
        <HedSection
          ...
          content='The quick embrace of serenity is the foundation of enduring connections. Cultivate the flame of trust and the bond grows stronge.'
        />
              ...
              <div key={id} className='card-parent'>
                <div className='rotatory-card'>
                  ...
                  <section className='card-back'>
                    ...
                    <p>{backContent}</p>
                    <Link to='/get-quote' className='btn btn-secondary'>get a plan</Link>
                  </section>
                </div>
              </div>
            );
