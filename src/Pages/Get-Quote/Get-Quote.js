...
function GetQuote() {
  ...
  <>
    ...
    <main id='main' className='get-quote'>
      <Hero title='get a plan' content='our construction teams are on-hand to help everyday'/>
        ...
        <div className='main-content'>
          <div className='container'>
            <HedSection
              ...
              content='Our team is dedicated to providing the guidance and support you need. Contact us today for personalized assistance.'
            />
            <Form/>
          </div>
        </div>
